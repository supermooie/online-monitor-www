...
var url = 'http://pulseatparkes.atnf.csiro.au/dev/plots/dfb4_fold_stokes.gif?' + random;
img.src = url;
document.getElementById('dfb4_fold_stokes').src = url;

// Pdfb4 fold plot: time vs phase (pav -YFp)
url = 'http://pulseatparkes.atnf.csiro.au/dev/plots/dfb4_fold_time.gif?' + random;
img.src = url;
document.getElementById('dfb4_fold_time').src = url;

// Pdfb4 fold plot: frequency vs time (pav -GTp)
url = 'http://pulseatparkes.atnf.csiro.au/dev/plots/dfb4_fold_freq.gif?' + random;
img.src = url;
document.getElementById('dfb4_fold_freq').src = url;

// PDFB4 fold plot: bandpass (pav -BTp)
url = 'http://pulseatparkes.atnf.csiro.au/dev/plots/dfb4_bandpass.gif?' + random;
img.src = url;
document.getElementById('dfb4_bandpass').src = url;
